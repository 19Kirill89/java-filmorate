...
Error:  /home/runner/work/java-filmorate/java-filmorate/src/main/java/ru/yandex/practicum/filmorate/storage/FilmDbStorage.java:39:17: ',' should be on the previous line. [SeparatorWrapComma]
...
Checkstyle ends with 6 errors. и чего хочет сонар я не могу понять
    ...
    public Film updateFilm(Film film) {
        String sqlQueryUpdateFilm = "UPDATE film SET name = ?, description = ?, release_date = ?, duration = ?, " +
                "rating_mpa_id = ? WHERE film_id = ?";
        int updateResult = jdbcTemplate.update(sqlQueryUpdateFilm, film.getName(),
